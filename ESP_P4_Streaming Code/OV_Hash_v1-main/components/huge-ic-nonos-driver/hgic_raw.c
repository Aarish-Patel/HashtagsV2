...
int hgic_raw_send(unsigned char *dest, unsigned char *data, unsigned int len)
{
    ...
    return hgic_raw_send_data(hgic.tx_buf, len + sizeof(struct hgic_frm_hdr2) + sizeof(struct hgic_eth_hdr));
}
...
int hgic_raw_send_ether(unsigned char *data, unsigned int len)
{
    ...
    return hgic_raw_send_data(hgic.tx_buf, len + sizeof(struct hgic_frm_hdr2));
}
